...
class sale_order(osv.osv):
    ...
    def to_state(self,cr,uid,ids,new_state,context=None):
        ...
        ''' 
        EMAIL_ACTIONS = {'review':{'msg':_('sales order submitted, need your review'),'groups':['ydit_sale_workflow.group_sale_reviewer']},
                         'engineer':{'msg':_('sales confirmed, need engineering approval'),'groups':['base.group_sale_salesman']},
                         'account':{'msg':_('engineering approved, need accounting approval'),'groups':['account.group_account_manager']},
                         'super':{'msg':_('accounting approved, need super approval'),'groups':['base.group_sale_salesman']},
                         'review2draft':{'msg':_('reviewer rejected, please do re-checking'),'groups':['base.group_sale_salesman']},
                         'super2engineer':{'msg':_('Super rejected, please do engineering re-checking'),'groups':['ydit_engineer.group_engineer_user']},
